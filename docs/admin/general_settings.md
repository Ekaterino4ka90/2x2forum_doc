...
:::tip
Рекомендуем использовать каринки размером: 350px х 150px.
:::
...
:::caution
По умолчанию стоит "Активация участников после подверждения почты".
:::
...
:::info
Если полность очистить поле и оставить его пустым, то будет просто добавляться ссылка откуда скопировали текст.
:::
...
:::danger
Лайкать посты могут только зарегестрированые пользователи.
:::
...
:::tip
Если захотите внести измнения в данный раздел, то после правок нажмите кнопку "Обновить".
:::
